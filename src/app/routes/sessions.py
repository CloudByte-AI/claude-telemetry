...
def sessions_list(request: Request, search: str = "", page: int = 1, per_page: int = 10, project: str = None, client: str = "all"):
    ctx = svc.get_sessions_list_context(search, page, per_page, project, client)
